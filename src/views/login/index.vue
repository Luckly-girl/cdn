        ...
        <el-form :model="userInfo" @submit.native.prevent>
          ...
          <div class="remember-me">
            ...
            <label
              ...
              >记住密码</label
            >
            <span class="forgetPwd" @click="$router.push('/forget')"
              >忘记密码？</span
            >
          </div>
          ...
          <el-form-item>
            <div class="registerBtn">
              没有账号？<span @click="$router.push('/regist')">立即注册</span>
            </div>
          </el-form-item>
        </el-form>
      </div>
    ...
    handlerSubmitBtn() {
      login(
        ...
        if (this.isActive) {
          ...
          // localStorage.setItem(this.userInfo.username, this.userInfo.password);
